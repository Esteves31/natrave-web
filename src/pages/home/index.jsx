    ...
    <div className="h-screen bg-red-700 p-4 text-white flex flex-col items-center space-y-6">
      ...
      <div className="container max-w-5xl flex-1 p-4 flex flex-col items-center md:flex-row space-y-6 md:space-y-0 md:space-x-6">
        ...
        <div className="md:flex-1 flex justify-center">
          <img src="/images/photo.png" className="w-full max-w-sm"/>
        </div>
        ...
        <div className="md:flex-1 flex flex-col space-y-6">
          ...
          <a href="/login" className="text-center text-white bg-red-700 border border-white text-xl px-6 py-4 rounded-xl">
            Fazer login
          </a>
        </div>
      </div>
